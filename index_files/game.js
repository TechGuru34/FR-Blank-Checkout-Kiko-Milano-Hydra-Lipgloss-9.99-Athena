...
$('.boxes .box').click(function (e) {
  ...
  if (curentBox.hasClass('active')) {
    ...
    curentBox.find('.box__front').css('background-image', "url('./index_files/box-lid-ios.png')");
    setTimeout(function () {
  ...
  if (curentBox.hasClass('second-step')) {
    curentBox.addClass('active');
    curentBox.addClass('noclick');
    curentBox.find('.box__inner').css('background-image', "url('./index_files/box-inner-gift.png')");
    curentBox.find('.box__front').css('background-image', "url('./index_files/box-lid-ios.png')");
    setTimeout(function () {
